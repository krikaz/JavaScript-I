...
for (let i = 0; i < inventory.length; i++) {
  if (inventory[i].id === 33) {
    a1 = inventory[i].car_make;
    b1 = inventory[i].car_model;
    c1 = inventory[i].car_year;
  }
}
console.log(`Car 33 is a ${c1} ${a1} ${b1}.`);

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = inventory[inventory.length - 1];
let a2 = lastCar.car_make,
  b2 = lastCar.car_model;

console.log(`Last Car is a ${a2} ${b2}.`);
...
let a3 = "";
for (let i = 0; i < inventory.length; i++) {
  a3 = inventory[i].car_model;
  carModels.push(a3);
}
let carModelsUnique = [...new Set(carModels)];
carModelsUnique.sort();
console.log(carModelsUnique);
...
let a4 = "";
for (let i = 0; i < inventory.length; i++) {
  a4 = inventory[i].car_year;
  carYears.push(a4);
}
let carYearsUnique = [...new Set(carYears)];
carYearsUnique.sort();
console.log(carYearsUnique);
